...
print('Генератор паролей с функциями')
...
print('Генератор паролей в словаре')
...
dict_unpack()                         # не могу распаковать используя **kwargs, но смог, используя возвращающую функцию
