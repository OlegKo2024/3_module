"""
Создайте функцию send_email, которая принимает 2 обычных аргумента: message(сообщение), recipient(получатель) и 1 обязательно именованный аргумент
...
def send_email(message, recipient, sender = 'university.help@gmail.com'):
    if ('@' not in recipient or '@' not in sender) or not (recipient.endswith('.com') or recipient.endswith('.ru') or\
        recipient.endswith('.net')) or not (sender.endswith('.com') or sender.endswith('.ru') or\
        sender.endswith('.net')):
